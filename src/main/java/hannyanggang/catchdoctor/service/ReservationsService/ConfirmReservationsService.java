...
@Service
public class ConfirmReservationsService {
    private final ReservationsRepository reservationsRepository;
    private final HospitalRepository hospitalRepository;
    @Transactional
    public ResponseEntity<?> confirmReservation(ReservationsDTO reservationsDTO, String hospitalId) {
